...
/*
 * HelpDeskCtrl - Stores Heldesk Data Flags
 */

function HelpDeskCtrl() {
    // Hardcode this for now, need to get from server!
    this.tgisCodeQuery = [{ Name: "Calls Logged" },
                        { Name: "Total Calls Registered" },
                        { Name: "Total Calls Current" },
                        { Name: "Total Calls Completed" }];
}
