...
namespace iCollect.NW.NW_Entities
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<Images2> Images2 { get; set; }
        public virtual DbSet<Links> Links { get; set; }
        public virtual DbSet<Links1> Links1 { get; set; }
        public virtual DbSet<Links2> Links2 { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Coins>(entity =>
            {
                ...
                entity.Property(e => e.ImageHeads).HasColumnType("image");

                entity.Property(e => e.ImageTail).HasColumnType("image");

                entity.HasOne(d => d.Set)
                    .WithMany(p => p.Coins)
                    .HasForeignKey(d => d.SetId)
                    .HasConstraintName("FK_Coins_Sets");
            });
            ...
            modelBuilder.Entity<Images2>(entity =>
            {
                entity.Property(e => e.CorrectPath).HasMaxLength(200);
            ...
            modelBuilder.Entity<Links1>(entity =>
            {
            ...
            modelBuilder.Entity<Links2>(entity =>
            {
